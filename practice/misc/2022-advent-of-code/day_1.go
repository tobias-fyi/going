...
Elf (with 11000 Calories), then the fifth Elf (with 10000 Calories). The sum of the Calories carried by these three elves is 45000.
...
// func main() {
// 	sums, err := scanFileAndCalcSortSums("input1.txt")
// 	if err != nil {
// 		log.Fatal(err)
// 	}

// 	top3Sum := sums[0] + sums[1] + sums[2]

// 	log.Println(top3Sum)
// }

// func scanFileAndCalcSortSums(file string) ([]int, error) {
// 	f, err := os.Open(file)
// 	if err != nil {
...
// 			if err != nil {
// 				log.Printf("failed to convert '%s' to integer: %v", s, err)
// 			} else {
// 				sum += c
// 			}
// 		}
